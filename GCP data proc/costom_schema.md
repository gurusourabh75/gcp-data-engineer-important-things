#  for give data we are defining costume schema

from pyspark.sql.types import StringType, StructField, IntegerType, FloatType, StringType
...
emp_schema=StructType([
    StruckField("empId" ,IntegerType(),True)
    StruckField("emp_name" ,StringType(),True)
    StruckField("emp_gender" ,StringType(),True)
    StruckField("emp_salary" ,FloatType(),True)
    StruckField("emp_location" ,IntegerType(),True)
])
