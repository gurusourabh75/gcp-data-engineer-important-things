...
- analysis 
 ...
 -  where both storage techiques clusterung and partictuning of data can be done 
...
--- important things in bq 

-- you  change the schema names as  ex :  schema  are id ,, name, date  ---->  id as track_id, name as track name , date as track date 
